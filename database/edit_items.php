                                ...
                                <div class="col-md-6">
                                  ...
                                  <?php
                                    if(isset($_GET["items_number"])){
                                        $items_number =$_GET["items_number"];
                                        ...
                                        if ($items_number != ""){
                                          ...
                                          $sql = "select * from Items where Items_Number = '$items_number'";
                                          $result = mysqli_query($conn, $sql);
                                          if(mysqli_num_rows($result) == 0)
                                                    echo "查無此資料";
                                          
                                          while ($row = mysqli_fetch_assoc($result)){
                                            echo "<form action='edit_items.php' method='post'><tr>";
                                            echo "<label>商品編號<font color='red'>*</font></label><br>";
                                            echo "<td>" . $row["Items_Number"] . "</td><br>";
                                            echo "<label>商品名稱<font color='red'>*</font></label><br>";
                                            echo "<td><input type='text' name='name' value='" . $row["Items_Name"] . "'></td><br>";
                                            echo "<label>商品數量<font color='red'>*</font></label><br>";
                                            echo "<td><input type='text' name='amount' value='" . $row["Items_Amount"] . "'></td><br>";
                                            echo "<label>商品價錢<font color='red'>*</font></label><br>";
                                            echo "<td><input type='text' name='price' value='" . $row["Items_Price"] . "'></td><br>";
                                          ...
                                          $amount = $_POST["amount"];
                                          $price = $_POST["price"];
                                          $sql_update = "UPDATE Items SET Items_Name = '$name', Items_Amount = $amount, Items_Price = $price WHERE Items_Number = $items_number";
                                          $result_update = mysqli_query($conn, $sql_update);

                                          if ($result_update) {
                                              echo "<table> <thead><tr>";
                                              echo "<td>編號#" . $number . "</td>&emsp";
                                              echo "<td>名稱" . $name . "</td>&emsp";
                                              echo "<td>數量" . $amount . "</td>&emsp";
                                              echo "<td>價錢$" . $price . "</td>&emsp";
                                              echo "<td> 更新成功 ! </td> </tr>";
                                              echo "</thead> </table>";
                                          } 
