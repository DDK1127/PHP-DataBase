                        ...
                        <div class="card">
                          <div class="card-body">
                              ...
                              <form action="" method="post" class="row g-3 needs-validation" novalidate>
								                ...
								                <!-- 商品全域搜尋（輸入編號、名稱） -->
                                <div class="col-md-6">
                                  <label for="items_number_label" class="form-label">商品全域搜尋（請正確輸入商品編號、商品名稱），若要查詢全部資料請在商品名稱輸入 *</label><br>
                                  商品編號<font color="red">*</font><input type="text" name="items_number" class="form-control" id="items_number_label" value="" >
                                  商品名稱<font color="red">*</font><input type="text" name="items_name" class="form-control" id="items_number_label" value="">
                            ...
                            <div class="card-body">
                                ...
                                <table id="zero-conf" class="display" style="width:100%">
                                    ...
                                    <tbody>
                                            ...
                                            echo "<td> <a href='edit_items.php?items_number=" . $row["Items_Number"] . "' class='btn btn-warning'>修改</a> </td>"; 
                                            echo "</tr>";
                                            }
                                          }
