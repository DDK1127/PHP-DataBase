                                    ...
                                    if(isset($_GET["customer_number"])){
                                        ...
                                        if ($customer_number != ""){
                                          ...
                                          while ($row = mysqli_fetch_assoc($result)){
                                            echo "<form action='edit_customer.php' method='post'><tr>";
                                            echo "<label>顧客編號<font color='red'>*</font></label><br>";
                                            echo "<td>" . $row["Customer_Number"] . "</td><br>";
                                            echo "<label>顧客姓名<font color='red'>*</font></label><br>";
                                            echo "<td><input type='text' name='name' value='" . $row["Name"] . "'></td><br>";
                                            echo "<label>手機號碼<font color='red'>*</font></label><br>";
                                            echo "<td><input type='text' name='phone' value='" . $row["Phone_Number"] . "'></td><br>";
                                            echo "<label>顧客地址<font color='red'>*</font></label><br>";
                                            echo "<td><input type='text' name='address' value='" . $row["Address"] . "'></td><br>";
                                          ...
                                          $sql_update = "UPDATE Customer SET `Name` = '$name', Phone_Number = $phone, `Address` = '$address' WHERE Customer_Number = $customer_number";
                                          $result_update = mysqli_query($conn, $sql_update);

                                          if ($result_update) {
                                              echo "<table> <thead>";
                                              echo "<tr>";
                                              echo "<td>編號#" . $customer_number . "</td>&emsp;";
                                              echo "<td>姓名" . $name . "</td>&emsp;";
                                              echo "<td>電話:" . $phone . "</td>&emsp;";
                                              echo "<td>地址:" . $address . "</td>&emsp;";
                                              echo "<td> 更新成功 ! </td> </tr>";
                                              echo "</thead> </table>";
                                          } 
