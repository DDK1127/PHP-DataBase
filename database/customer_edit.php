    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                      ...
                      <div class="col">
                        <div class="card">
                          <div class="card-body">
                              ...
                              <p>請輸入要新增的顧客資料。</p>
                              <form action="customer_edit.php" method="post" class="row g-3 needs-validation" novalidate>
								...
								<!-- 商品名稱 -->
                                <div class="col-md-2">
                                  <label for="name_label" class="form-label">顧客名稱<font color="red">*</font></label>
                                  <input type="text" name="customer_name" class="form-control" id="name_label" value="" required>
                                  <div class="valid-feedback">
                                    輸入正確！
                                  </div>
                                </div>
                ...
                <!-- 商品數量 -->
                                <div class="col-md-3">
                                  <label for="phone_number_label" class="form-label">顧客電話<font color="red">*</font></label>
                                  <input type="text" name="customer_phone" class="form-control" id="phone_number_label" value="" required>
                                  <div class="valid-feedback">
                                    輸入正確！
                                  </div>
                                </div>
								...
								<!-- 商品價格 -->
                                <div class="col-md-4">
                                  <label for="address_label" class="form-label">地址<font color="red">*</font></label>
                                  <input type="text" name="customer_address" class="form-control" id="address_label" value="" required>
                                  <div class="valid-feedback">
                                    輸入正確！
                                  </div>
                                </div>
                                            ...
                                            <?php
                                                if(isset($_POST["customer_number"]) && isset($_POST["customer_name"]) && isset($_POST["customer_phone"]) && isset($_POST["customer_address"])){
                                                    ...
                                                    if ($customer_number != "" && $customer_name != "" && $customer_phone != "" && $customer_address != ""){
                                                        ...
                                                        if(mysqli_num_rows($result_check) > 0){echo "<td> 相同顧客資訊已存在 </td>";}
                                                        else{
                                                            ...
                                                            if($result_insert){
                                                                ...
                                                                echo "<td> <a href='edit_customer.php?customer_number=" . $customer_number . "' class='btn btn-warning'>修改</a> </td>";
                                                                echo "<td> 新增成功 ! </td> </tr>"; 
                                                            }
                                                ...
                                                if(isset($_POST["delete_number"])){
                                                  ...
                                                  if($delete_number != ""){
                                                    ...
                                                    $sql_check = "SELECT * FROM Customer WHERE Customer_Number = '$delete_number'";
                                                    $result_check = mysqli_query($conn, $sql_check);
                                                    if(mysqli_num_rows($result_check) <= 0){echo "<td> 找不到商品 </td>";}
                                                    else{
                                                      $sql_insert = "DELETE FROM Customer WHERE Customer_Number = '$delete_number'";
                                                      $result_insert = mysqli_query($conn, $sql_insert);
                                                      if($result_insert){
                                                        echo "<tr>";
